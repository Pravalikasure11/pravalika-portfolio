...
const links = {
  ...
  resume: ASSET_BASE + 'Pravalika_Sure_HP_BusinessPlanning.pdf',
};
...
const otherProjects = [
  {
    ...
    description:
      'Built forecasting and revenue reporting workflows with variance tracking, MAPE-based evaluation, and business-facing summaries for decision support.',
...
const strengthCards = [
  {
    ...
    text: 'Built dashboards, reporting workflows, forecasting systems, and business-facing KPI layers.',
  },
  {
    icon: BrainCircuit,
    title: 'Product Thinking',
    text: 'Designed systems around real operational workflows, data flow, and decision support.',
  },
  {
    icon: ShieldCheck,
    title: 'Security Mindset',
    text: 'Structured apps with secure authentication, role-aware access, and production-style architecture.',
  },
  {
    icon: Briefcase,
    title: 'Business Impact',
    text: 'Focused on margin, inventory, revenue visibility, seasonal demand, and supplier intelligence.',
  },
];
...
const certifications = [
  {
    ...
    detail:
      'Focused on data loading patterns, orchestration, scalable data architectures, and analytics solution management in Microsoft Fabric.',
...
const achievements = [
  {
    ...
    detail:
      'Helped host, organize, coordinate, and volunteer across multiple college events under the Computer Society of India chapter, supporting participation, execution, and community engagement.',
  },
  {
    title: 'Top 5% of Class',
    detail:
      'Graduated in the top 5% during undergraduate studies, reflecting strong academic consistency and execution.',
  },
];
        ...
        <div className="hero-copy">
          ...
          <div className="button-row">
            <a className="btn btn-primary" href="#featured-project">
              View Featured Project <ArrowRight size={16} />
            </a>
            <a className="btn btn-secondary" href={links.resume} target="_blank" rel="noreferrer">
        ...
        <div className="about-layout">
          <div className="strength-grid">
            {strengthCards.map((item) => {
              ...
              return (
                <div key={item.title} className="card strength-card">
                  <Icon size={20} />
                  <h3>{item.title}</h3>
                  <p>{item.text}</p>
                </div>
          ...
          <div className="about-card-grid">
            {aboutCards.map((item) => {
              const Icon = item.icon;
              return (
                <div key={item.text} className="card about-card">
                  <Icon size={20} />
                  <p>{item.text}</p>
                </div>
              );
    ...
    <section id="projects" className="section-shell bordered">
      <div className="container">
        <SectionHeading
          ...
          title="Analytics and business systems projects"
          subtitle="Projects shaped around forecasting, decision support, inventory analytics, and measurable business value."
        />
  ...
  return (
    <section id="skills" className="section-shell bordered">
      <div className="container">
        <SectionHeading
          eyebrow="Skills"
          title="Technical, analytical, and business-facing strengths"
          subtitle="A portfolio of skills spanning development, analytics, reporting, communication, and business problem solving."
        />
    ...
    <section className="section-shell bordered">
      <div className="container">
        <SectionHeading
          ...
          title="Technical depth and structured business learning"
          subtitle="Programs and certifications that strengthen both my engineering capability and business thinking."
        />
    ...
    <section className="section-shell bordered">
      <div className="container">
        <SectionHeading
          ...
          title="Experiences that reflect initiative, ownership, and community involvement"
          subtitle="A mix of academic performance, student leadership, and event support that shaped how I work with people and execute ideas."
        />
    ...
    <section className="section-shell bordered">
      <div className="container">
        <SectionHeading
          ...
          subtitle="Strong grounding in data science, computer science, analytics, and business-oriented problem solving."
        />
        <div className="project-grid two-up">
          <article className="card edu-card premium">
            <div className="edu-row">
              <div className="edu-logo-wrap">
                <img src={ASSET_BASE + 'umd.png'} alt="University of Maryland logo" className="edu-logo" />
              </div>
              <div>
          ...
          <article className="card edu-card premium">
            <div className="edu-row">
              <div className="edu-logo-wrap">
                <img src={ASSET_BASE + 'vnr.png'} alt="VNR VJIET logo" className="edu-logo" />
              </div>
              <div>
                <h3>VNR VJIET</h3>
      ...
      <div className="container">
        ...
        <div className="story-layout">
          ...
          <div className="story-text card premium">
            ...
            <p>
              That curiosity turned into action when I began structuring and organizing business data digitally,
              making it easier to retrieve and analyze.
            </p>

            <p>
              Today, I see data as more than analysis — it’s about building systems that bring clarity,
              improve transparency, and help businesses make smarter decisions.
            </p>
          </div>
